...
import com.github.quiltservertools.ledger.config.util.ResourceLocationMixin
...
val config: Config = Config {
    ...
    .apply { this.mapper.addMixIn(ResourceLocation::class.java, ResourceLocationMixin::class.java) }
